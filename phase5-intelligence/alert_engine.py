...
_ENKIDU = _HERE.parent
_TOOLS_PATH = _ENKIDU / "phase2-tool-use" / "tools"
_PHASE4 = _ENKIDU / "phase4-memory"
...
load_dotenv(str(_ENKIDU / ".env"))

logging.basicConfig(format="%(asctime)s [%(levelname)s] %(message)s", level=logging.INFO)
logger = logging.getLogger("enkidu.alerts")
...
def _send_telegram(text: str) -> bool:
    """Send a message to the authorized user via the Enkidu bot."""

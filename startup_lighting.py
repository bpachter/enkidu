"""
startup_lighting.py — Enkidu idle lighting at Windows logon
...
Runs silently in the background.  The Enkidu bot will call
...
# ── Point Python at the Enkidu package so we can reuse lighting.py ──────────
import os

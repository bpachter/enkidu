# Gandalf UI — React Client

![Gandalf UI hero shot](../../assets/phase6-ui-hero.png)
...
Custom Blade Runner terminal dashboard for the Gandalf AI assistant. Replaces Open WebUI with a purpose-built interface.
...
```
┌──────────────────────────────────────────────────────────────────┐
│  GANDALF  v8.0   VRAM 72%   62°C   285W        2026.04.16  ONLINE │
├──────────────┬───────────────────────────┬───────────────────────┤
...
2. **Gandalf agent** (`run_agent()`) — Gemma/Claude routing, tool use, streaming tokens
